...
public class FirebaseStorageServiceImpl implements FirebaseStorageService {
    ...
    @Override
    public String cargaImagen(MultipartFile archivoLocalCliente, String carpeta, Long id) { //METODO PARA SUBIR IMAGENES
        try {
    ...
    private String uploadFile(File file, String carpeta, String fileName) throws IOException {
        ...
        //Objeto tipo ClassPathResource para leer rutas rutaJsonFile esta en el firestorage service
        ...
        String url = storage.signUrl(blobInfo, 3650, TimeUnit.DAYS, com.google.cloud.storage.Storage.SignUrlOption.signWith((ServiceAccountSigner) credentials)).toString();
        return url;
    }
